...
//		}
    ...
    private void init() {
        ...
        borderWidth = Math.round(1 * (displayMetrics.xdpi / DisplayMetrics.DENSITY_DEFAULT));
...
//            canvas.drawLine(colorPickerBody.left, selectorYPos, colorPickerBody.right, selectorYPos, strokePaint);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int[] colors = {0xffff0000, 0xffffff00, 0xff00ffff, 0xffff00ff};
...
//        selectorYPos = borderWidth + colorPickerRadius;
        ...
        if (onColorChangeListener != null) {
            onColorChangeListener.onColorChange(Color.WHITE);
        }
